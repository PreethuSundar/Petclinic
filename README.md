111# Spring PetClinic Sample Application  
...
This pwroject allows the Spring community to maintain a Petclinic version with a plain old **Spring Framework configuration**
